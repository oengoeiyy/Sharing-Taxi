...
class FromSavedSubmitScreen extends StatefulWidget {
  ...
  _FromSavedSubmitScreenState createState() => _FromSavedSubmitScreenState();
}

class _FromSavedSubmitScreenState extends State<FromSavedSubmitScreen> {
  String address = '';
  ...
  void initState() {
    ...
    detail.text = widget.detail.toString();
    placeName.text = widget.placeName.toString();
            ...
            onPressed: () async {
              if (isProcessing == true) {
                Fluttertoast.showToast(
                    msg: "Your journey creation is processing.",
